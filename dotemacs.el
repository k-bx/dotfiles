...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("59820d0ca7ba29984ab4d255f9fcfaa28041ad6ae4b6ae2ffb2ccfbfaec210e4"
	 ...
	 "27d99e38ac398c1d6a4b9fd027cc0cd2bbf53de9da13a1306f9ecdb70d8fa9dd"
	 "144f297981a22c35e14fa0a73748c6d71a7accc031e2cb97785f3782ff236b1b"
	 "0681a3c8f9b8187a63070e59672b1df428c1695c56f64bbe0b69b10b01291f67"
	 "1927fbaf301d12eb45f8b68be6992dba75c0153a86a32cba0f1571c223e38c44"
	 "807fcb675c5c20fac8a23854d07557050049a9502fc87166ac84c9bac6dc32b7"
	 "fda96eb444c409c9d7a2eb1c5a08911dba6559c5e74cc378da397e390d6261b0"
	 "ffb7dcb4f01bdb13825577fb686422dd9c2e65f56bc12029c9147db53c56fa56"
	 "19148913c2ac4d941fac49c1a415293890f98037d53bb899635a98ff80cc2da0"
	 "ccc7f955188fd39d347ea6f5345fed986ae66e054b3da9b23b5c336026e3c757"
	 "59ed08918a5739ec41af343b67a5a4c7cb17b31da49ed409170d1b45c1ccd0cf"
	 "f44a3a5f5f365768a8ac5e17a8b3a4ac05434fb3389afc6f531612382b4340b9"
	 "22fdf3a487954a54eccf91748bef751877687178b936501a2079b51ae056b6cf"
	 "ec5be26eee2af05cbfef6bc3cbc48b4eba01e05953f118bec1d67af3a8060983"
	 ...
	 "0aff51567909d728332ba22631bcb2cc4890130dc1261447663ff6147506f847"
	 "99b077e8d793e87e20447d4b52055b2def8c083d09a9800706fe691ac06ef956"
	 ...
	 "911718851dfaac9e14bfe277aedef9407b759689df8692dddb193fc370082c80"
	 "4b31c03b485367cc56647504ceeca4d657db6d2d1dda295455a5c5259d8fcd75"
	 "6450867a05ce9126b6e6592373b6bbaaf65e637bc27ecc6e9b0375b8cf2ab744"
	 "51dc5b02318828dc0b725ab7c85d8d5cd5b179212bce4aefc3f9db2db00190f4"
	 "32774da9de62df0730e898bd46a1b8be1bde53f236a715dde064c4c1c03a0681"
	 "15569f9ded25f6f841f284eb34a55e17ee4c2b6aa2795158fff6229f585b0bb6"
	 "0fc74cd0e50009abbb8777981ea54dffaa3840f29d1db65ad95f7ca83cbff929"
	 "73078af00076117610bb88f3ef3fe85190a80a85b18a697a8c98d09f593bf4cd"
	 "35193cc0ca34817887bd0a1f88a85679454f36630c3df59dad78e969af9c1c5e"
	 "9eecc40c7205eb97d7c76cab1ce0dfff5ef08a1974830e552b6f48af2e6a2e69"
	 "3fc730c9f3161df13f1ac4d88c7e5e4d4e3477cf8246cfdc794afdf2d72cc625"
 ...
 '(grep-find-ignored-directories
   '("SCCS" "RCS" "CVS" "MCVS" ".svn" ".git" ".hg" ".bzr" "_MTN" "_darcs"
	 "{arch}" "cabal-dev" "dist" "build" ".cabal-sandbox" ".idea"
	 "*.egg-info" ".stack-work"))
 '(grep-find-ignored-files
   '(".#*" "*.o" "*~" "*.bin" "*.lbin" "*.so" "*.a" "*.ln" "*.blg"
	 ...
	 "*.pgs" "*.tps" "*.vrs" "*.pyc" "*.pyo" "*.sublime-workspace"
	 "*_flymake*"))
 '(grep-find-template
 ...
 '(projectile-switch-project-hook
   '((lambda nil (interactive) (set-title (projectile-project-name)))))
 ...
 '(safe-local-variable-values
   '((eval setenv "PYTHONPATH" (concat here "" ":" (getenv "PYTHONPATH")))
	 (eval setenv "PYTHONPATH"
		   (concat here "" ":" here "ec2" ":" here "lambdas" ":"
				   (getenv "PYTHONPATH")))
	 (eval setq flycheck-pylintrc (here ".pylintrc"))
	 (eval setenv "PYTHONPATH"
		   (concat here "ec2" ":" here "lambdas" ":"
				   (getenv "PYTHONPATH")))
	 (eval setenv "PYTHONPATH"
		   (concat here "ec2" ":" (getenv "PYTHONPATH")))
	 (eval setenv "PYTHONPATH"
	 ...
	 (eval setenv "NIX_PATH"
		   "nixpkgs=https://github.com/nixos/nixpkgs/archive/681db603640dac395b0f76eb666f39019457131b.tar.gz")
	 ...
	 (dante-repl-command-line "stack" "repl"
							  ...
							  dante-target)
	 (dante-repl-command-line "stack" "repl"
							  "--ghc-options=\"-j -fno-code -fobject-code\""
							  dante-target)
	 ...
	 (haskell-process-use-ghci . t) (haskell-indent-spaces . 2)))
